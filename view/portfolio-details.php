...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <div>
        <a href="dashboardUser/dashboard.html" class="get-started-btn scrollto">Login</a>
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="../assets/assets2/img/portfolio/coffe1.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="../assets/assets2/img/portfolio/coffe2.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="../assets/assets2/img/portfolio/portfolio-3.jpg" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Client</strong>: Xoxo Company</li>
                <li><strong>Tanggal Project</strong>: 01 Desember, 2020</li>
                <li><strong>Project URL</strong>: <a href="#">www.NgopiKudus.com</a></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>Detail Produk</h2>
              <p>
                NgopiKudus adalah sebuah website yang diperuntukkan dalam menginformasi kedai-kedai kopi terkenal yang
                ada di Kudus serta informasi khusus mulai dari pembibitan, perawatan, hingga proses pemasaran dalam
                pembuatan kopi tersebut </p>
            </div>
          </div>
