...
<body>
    ...
    <header id="header" style="background-color: #000000CC;">
        <div class="container d-flex align-items-center justify-content-lg-between">

            <h1 class="logo me-auto me-lg-0"><img style="margin-right: 10px; margin-bottom: 5px;"
                    src="../assets/assets2/img/gb_ku/logo.png" alt=""><a href="index.html">QudsDev<span>.</span></a></h1>
            <!-- Uncomment below if you prefer to use an image logo -->
            <!-- <a href="index.html" class="logo me-auto me-lg-0"><img src="../assets/assets2/img/logo.png" alt="" class="img-fluid"></a>-->

            <nav id="navbar" class="navbar order-last order-lg-0 fixed-top">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Product</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            ...
                            <li class="dropdown"><a href="#"><span>Merchandise</span> <i
            ...
            <form class="form-horizontal" method="post" action="">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-push-6 col-sm-push-6">
                    ...
                    <div class="panel panel-info">
                        <div class="panel-heading text-white" style="background-color: #000000CC; ">

                            Review Order <div class="pull-right"><small><a class="afix-1" href="#"
                                        style="color: white;">Edit Cart</a></small></div>
                        </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-pull-6 col-sm-pull-6">
                    <!--SHIPPING METHOD-->
                    <div class="panel panel-info">
                        <div class="panel-heading text-white" style="background-color: #000000CC;">Address</div>
                        <div class="panel-body">
                            <div class="form-group">
                                <div class="col-md-12">
                    ...
                    <!--CREDIT CART PAYMENT-->
                    <div class="panel panel-info">
                        <div class="panel-heading text-white" style="background-color: #000000CC;"><span><i
                                    class="glyphicon glyphicon-lock"></i></span> Secure Payment</div>
                        <div class="panel-body">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <button type="submit" class="btn btn-primary btn-submit-fix"
                                        style="background-color: #000000CC;">Place Order</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 footer-newsletter">
                        <h4>Bantuan</h4>
                        <p>Silahkan teman-teman subscribe website ini dan semoga kedepannya bisa lebih baik terutama
                            peningkatan
                            skill
